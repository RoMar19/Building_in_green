...
## UI
**Colors, Fonts & Layout**
The layout is base on a Theme template from startbootstrap.com.
...
2. Search and filter different types of green buildings of other users of the Comunity per 
   categories base on main material used. Each bulding/house 
...
4. Users can also Edit a house from the data base or even deleted with warning alert about changes and delection. 

**User stories:**
* As a first-time user, I want to view Green Buildings to get inspiration.
* As a first-time user, I want to use the plataform to share my eco-friendly house.
...
* As an administrator, I want to be able change previous projects, upload new projects and delete to clean the data base.
...
Displays all the records of the Comunity. It is also possible to filter by category (Wood, Cob, Stone or Upcycling).
...
* Location
* Description
Collection "houses" stored as an string at MongoDB.

We have 2 buttons:
* Delete: On click we will get and alarm with text:
 *This process cannot be undone! Are you sure you want to delete this house?*. 
  with options to continue (OK) or cancel the operation. After click OK, open Home page.
...
Materializecss.com Form and jQuery for the initializatoin added.
...
* Update: This button must be clicked to save the changes of the records. And an alert message will show:
  *Thank you! The building has been updated successfully.* After click OK, open View More Details page.
* Cancel: If we click on cancel, we will get and alert with the next message: 
  *Your building has not been edited.* After click OK, open View More Details page.
...
* Insert: On click add the records to the data base of the Comunity, and you will see an alert with text:
*"Thank you! The building has been added successfully."* After click OK, open View More Details page.
  where you can Delete or Edit the inserted data. To view your record added to the Community user has to click on:
  *To view your Green Building added to the Comunity visit the Gallery*
* Cancel: On click it will cancel the operation and nothig will be added to the data base. 
  Alert with the next message shown: 
  *Your building has not added.* After click OK, open View More Details page.
...
were used for Forms and select.
...
selected options in the dropdown remains unchanged. Clear the dropdowns function must be implemented in future.
